...
#INITIAL_AMMO_STOCKS = {Cannon: 9, HighVelocityCannon: 7, FireworkLauncher: 2,
#                       SLD_Launcher: 2, MineLayer: 2, ShieldGenerator: 2}
...
SPAWN_LIMIT = lambda: it.repeat(3)
...
RAD_BORDER = lambda: it.repeat(0.3)
